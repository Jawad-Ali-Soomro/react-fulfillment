    ...
    <div className="home-page">
      <div className="main-hero">
        ...
        <div className="bottom-content">
          <p>
            We had made it <span>simple</span>, and we take care of the tough parts for you with:
          </p>
      ...
      <div className="work-flow">
        <div className="content">
          <h4>HOW IT WORKS</h4>
          <p>
            Librex is not your conventional Third Party Logistics partner (3PL).
            We strive to make the fulfillment process painless and easy to
            understand. With our trustworthy customer service and flat rate
            shipping fees there are never any surprise costs.
          </p>
          <p>
        ...
        <div className="left">
          ...
          <ul>
            {tab == "Dashboard" ? (
              ...
              <li className="tab-inactive" onClick={() => setTab("Dashboard")}>
                Dashboard
              </li>
            )}
            {tab == "Orders" ? (
            ...
            {tab == "Inventory" ? (
              ...
              <li className="tab-inactive" onClick={() => setTab("Inventory")}>
                Inventory
              </li>
            )}
            ...
            <div className="right-main">
              <section className="content">
                ...
                <p>
                  ...
                  your orders are being processed in real time. Our Librex Go
                  Dashboard supports seamless integrations with unlimited
                  selling channels.
                </p>
                <h3>FEATURES</h3>
                <div className="feature-step">
            ...
            <div className="right-main">
              <section className="content">
                ...
                <p>
                  ...
                  when you have multiple selling channels. Our in-house software
                  takes all the stress off of having to keep track of your
                  inventory.
                </p>
                <h3>FEATURES</h3>
                <div className="feature-step">
            ...
            <div className="right-main">
              <section className="content">
                ...
                <div className="feature-step">
                  <span>2</span>
                  <h5>
                    Retail Storage Network keeps your inventory closest to your
                    customers
                  </h5>
                </div>
              </section>
